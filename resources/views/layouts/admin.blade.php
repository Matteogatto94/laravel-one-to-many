...
<head>
    ...
    <!-- Fontawesome -->
    <script src="https://kit.fontawesome.com/ed938e571a.js" crossorigin="anonymous"></script>
...
<body>
    <div id="app">
        <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
            <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="#">Laravel Auth</a>
